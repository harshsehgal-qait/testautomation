...
public class KSEU_750_UK_Checkout_Verify_That_Customer_Is_Able_ToFind_Address_By_Enterng_Zip_Code extends KateSpadeTest {
	...
	@Test(groups = { "desktop", "mobile" })
	public void TestStep09_Verify_Functionality_Of_Find_Address_Btn_In__Billing_Step() {
		dsl.verifyFunctionalityOfFindAddressButtonInBillingPage(shipping.get("Zip"));
	}
}
