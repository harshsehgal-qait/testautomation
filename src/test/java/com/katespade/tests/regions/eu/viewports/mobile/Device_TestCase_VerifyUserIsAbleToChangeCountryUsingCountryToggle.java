...
public class Device_TestCase_VerifyUserIsAbleToChangeCountryUsingCountryToggle extends KateSpadeTest {
	...
	public void TestStep03_VerifyutilityNavigationBar() {
		dsl.mobile_utilityNavigationBar();
	}
	...
	@Test(groups = { "desktop", "mobile" })
	public void TestStep06_VerifyHelpLinkIsDisplayed() {
	...
	@Test(groups = { "desktop", "mobile" })
	public void TestStep07_VerifyStoreLocatoreIcon() {
