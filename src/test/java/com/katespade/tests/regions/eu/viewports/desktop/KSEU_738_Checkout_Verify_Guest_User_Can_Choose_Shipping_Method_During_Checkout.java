...
public class KSEU_738_Checkout_Verify_Guest_User_Can_Choose_Shipping_Method_During_Checkout extends KateSpadeTest{

	Map<String, String> url;
	Map<String, String> products;
	Map<String, String> users;
	Map<String, String> shipping;
	int shippingMethodCount = 2;
	...
	@Test(groups = { "desktop", "mobile" })
	public void TestStep07_Verify_That_Order_Summary_Is_Updated_According_To_The_Shipping_Method() {
		dsl.verifyOrderSummaryIsUpdatedAccordingToTheShippingMethod();
	}
