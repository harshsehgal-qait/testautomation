...
public class KSEU_772_Login_Verify_Guest_User_Has_Option_To_Check_Their_Orders extends KateSpadeTest{
	...
	public void TestStep03_Verify_Sign_In_Section_Of_Guest_Order_Check_Page() {
		dsl.verifyEmailAndPwdAreMandatoryFieldsInGuestOrderCheckPage();
	...
	public void TestStep04_Verify_Check_Field_Cant_Be_Left_Empty() {
		dsl.verifyCheckOrderFieldsCannotBeLeftEmpty();
	}
