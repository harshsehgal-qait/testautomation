...
public class KSEU_676_Variation_Master_Recommendations extends KateSpadeTest{
	...
	@Test(groups = { "desktop", "mobile" })
	public void TestStep05_Verify_Product_Images_Are_Loaded() {
		dsl.verifyProductImagesAreLoadedUsingAdobeScene7InPDP();
	}
	
	@Test(groups = { "desktop", "mobile" })
	public void TestStep06_Verify_Sales_Price_For_Recommended_Product() {
		dsl.verifySalesPriceForRecommendedProduct();
	}
	
	@Test(groups = { "desktop", "mobile" })
	public void TestStep07_Select_Product_From_Recommended_List_And_Verify_In_PDP_Page() {
