...
public class KSEU_737_VerifyForGuestUser_CountryDropdownWillShowCountryThatTheUserIsOn extends KateSpadeTest {
	...
	public void start_test_session() {
		...
		country = testData.get("Country And Currency").get(0);
	}
	...
	@Test(groups = { "desktop", "mobile" })
	public void TestStep06_VerifyCountryDropdownWillShowCountryThatTheUserIsOn() {
		dsl.verifyCountryDropdownWillShowCountryThatTheUserIsOn(country.get("Country"));
