...
public class KSEU_FR_660_VerifyContentBrowsePage_GeneralElements extends KateSpadeTest {
	...
	@Test(groups = { "desktop", "mobile" })
	public void Test_Step03_Verify_BreadCrumb_Icon_On_Shop_Grid_Page() {
	...
	@Test(groups = { "desktop", "mobile" })
	public void Test_Step07_Verify_Product_Count_Is_Changed_As_Per_Refinement_In_Shop_Grid_Page() {
