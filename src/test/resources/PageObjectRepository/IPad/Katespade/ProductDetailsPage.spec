...
icon_writeReview											css							.BVRRRatingSummaryLink.BVRRRatingSummaryNoReviewsWriteImageLink
...
label_detail												css							#small-description .short-right>p
...
img_recommendedProduct										css							.product-tile.tooltip img
label_mostRecentlyViewedHeader								css							.product-listing.last-visited h2
list_mostRecentlyViewedItemsImage							css							.product-tile .product-image
...
pdp_thumbnail												css							.primary-image
...
salesPrice_recommendedItem									css							.recommendation-item .price-sales
...
dropdown_qty												css							.availability-web-mobile+.inventory #Quantity
