...
Product_Name							xpath					(//div[@class='item-details']//div[@class='name '])[${text}]	
...
button_first_addTobag					css 				    [name="dwfrm_wishlist_items_i0_addToCart"]
...
checkBox_RememberMe                     css                     label[for="dwfrm_login_rememberme"]			
